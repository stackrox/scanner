	...
	testData := []featurefmt.TestData{
		// Test an Ubuntu dpkg status file
		{
			...
			Files: tarutil.FilesMap{
				...
				"test/executable":                           &tarutil.FileData{Contents: nil, Executable: true},
				"another/one":                               &tarutil.FileData{Contents: nil, Executable: true},
				"i/am/an/executable":                        &tarutil.FileData{Contents: nil, Executable: true},
				...
				"exec-me":                                   &tarutil.FileData{Contents: nil, Executable: true},
				"exec-me-2":                                 &tarutil.FileData{Contents: nil, Executable: true},
			},
		},
	}
