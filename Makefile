...
WORKDIR_FLAG := --workdir /go/src/github.com/stackrox/scanner
...
scanner-build-dockerized: deps
	@echo "+ $@"
ifdef CI
	docker container create $(WORKDIR_FLAG) --name builder $(BUILD_IMAGE) $(BUILD_CMD)
	...
	docker run $(WORKDIR_FLAG) $(BUILD_FLAGS) $(GOPATH_WD_OVERRIDES) $(LOCAL_VOLUME_ARGS) $(BUILD_IMAGE) $(BUILD_CMD)
endif
