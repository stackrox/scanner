...
BUILD_IMAGE := stackrox/scanner:builder-2
...
scanner-image: scanner-build-dockerized ossls-notice $(CURDIR)/image/scanner/rhel/bundle.tar.gz
	@echo "+ $@"
	@docker build -t us.gcr.io/stackrox-ci/scanner:$(TAG)  -t stackrox/scanner:$(TAG) -f image/scanner/rhel/Dockerfile image/scanner/rhel
...
db-image: $(CURDIR)/image/db/rhel/bundle.tar.gz
	...
	@docker build -t us.gcr.io/stackrox-ci/scanner-db:$(TAG) -t stackrox/scanner-db:$(TAG) -f image/db/rhel/Dockerfile image/db/rhel
