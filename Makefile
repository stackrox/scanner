...
$(CURDIR)/image/scanner/bundle.tar.gz: build
...
.PHONY: scanner-image
scanner-image: scanner-build-dockerized $(CURDIR)/image/scanner/bundle.tar.gz
	@echo "+ $@"
...
db-image: $(CURDIR)/image/db/bundle.tar.gz
	...
	@docker build -t us.gcr.io/stackrox-ci/scanner-db:$(TAG) -f image/db/Dockerfile image/db
