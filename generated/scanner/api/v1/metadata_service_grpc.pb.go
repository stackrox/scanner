...
// UnimplementedVulnDefsServiceServer should be embedded to have
...
func (UnimplementedVulnDefsServiceServer) testEmbeddedByValue() {}
...
func RegisterVulnDefsServiceServer(s grpc.ServiceRegistrar, srv VulnDefsServiceServer) {
	// If the following call pancis, it indicates UnimplementedVulnDefsServiceServer was
