...
func RegisterVulnDefsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server VulnDefsServiceServer) error {
	...
	mux.Handle("GET", pattern_VulnDefsService_GetVulnDefsMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/scannerV1.VulnDefsService/GetVulnDefsMetadata", runtime.WithHTTPPathPattern("/v1/vulndefs/metadata"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_VulnDefsService_GetVulnDefsMetadata_0(ctx, inboundMarshaler, server, req, pathParams)
...
func RegisterVulnDefsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client VulnDefsServiceClient) error {
	...
	mux.Handle("GET", pattern_VulnDefsService_GetVulnDefsMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/scannerV1.VulnDefsService/GetVulnDefsMetadata", runtime.WithHTTPPathPattern("/v1/vulndefs/metadata"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_VulnDefsService_GetVulnDefsMetadata_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
