...
func RegisterVulnDefsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server VulnDefsServiceServer) error {
	mux.Handle(http.MethodGet, pattern_VulnDefsService_GetVulnDefsMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
// "VulnDefsServiceClient" to call the correct interceptors. This client ignores the HTTP middlewares.
