...
// UnimplementedNodeScanServiceServer should be embedded to have
...
func (UnimplementedNodeScanServiceServer) testEmbeddedByValue() {}
...
func RegisterNodeScanServiceServer(s grpc.ServiceRegistrar, srv NodeScanServiceServer) {
	// If the following call pancis, it indicates UnimplementedNodeScanServiceServer was
